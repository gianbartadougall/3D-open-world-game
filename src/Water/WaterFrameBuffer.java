...
public class WaterFrameBuffer {
    ...
    // can change resolutions - lower the resolution, the less taxing it is on the gpu
    ...
    private int createFrameBuffer() {
        int frameBuffer = GL30.glGenFramebuffers(); // creates new frame buffer and returns id of the buffer
        GL30.glBindFramebuffer(GL30.GL_FRAMEBUFFER, frameBuffer); // bind frame buffer
